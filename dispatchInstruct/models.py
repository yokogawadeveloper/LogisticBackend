...
class SAPDispatchInstruction(models.Model):
    ...
    delivery_create_date = models.DateField(auto_now=True, auto_now_add=False)
    ...
    tax_invoice_date = models.DateField(auto_now=True, auto_now_add=False)
    ...
    billing_create_date = models.DateField(auto_now=True, auto_now_add=False)
    ...
    dil_output_date = models.DateField(auto_now=True, auto_now_add=False)
    ...
    packed_unit_quantity = models.IntegerField(null=True, blank=True)
    # default fields
    created_by = models.ForeignKey(User, related_name='+', null=True, on_delete=models.CASCADE, blank=True)
    created_at = models.DateTimeField(auto_now_add=True, null=True)
    updated_by = models.ForeignKey(User, related_name='+', null=True, on_delete=models.CASCADE, blank=True)
...
class DispatchInstructionBillDetails(models.Model):
    ...
    lingage_no = models.CharField(max_length=100, null=True, blank=True)
...
class MasterItemList(models.Model):
    ...
    serial_flag = models.CharField(max_length=100, null=True, blank=True)
